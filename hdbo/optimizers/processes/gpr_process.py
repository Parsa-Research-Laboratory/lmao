...
class GPOptimizerProcess(BaseOptimizerProcess):
    """
    Represents a process for the GP optimizer.

    This class provides an implementation for the GP optimizer process.
    ...
    def __init__(self, num_params: int, num_repeats: int = 1,
        ...
        """
        Initialize a GPOptimizerProcess object.
